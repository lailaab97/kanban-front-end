<template>
  <f7-page>
    ...
    <f7-list>
      <f7-list-item link="/developers/" title="Developers"></f7-list-item>
      <f7-list-item link="/tasks/" title="Tasks"></f7-list-item>
      <f7-list-item link="/addTask/" title="Add Task"></f7-list-item>
    </f7-list>
